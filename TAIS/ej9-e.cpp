...
long int voraz2(Dijkstra<int> a1, Dijkstra<int> a2, DigrafoValorado<int> g) {
    ...
    while (cont < g.V() - 2) {
        ...
        if (n[contN].value < s[contS].value && insertN < max) {
            if (!visit[n[contN].elem] && a1.distancia(n[contN].elem) < a2.distancia(n[contN].elem)) {
        ...
        else if (s[contS].value < n[contN].value && insertS < max) {
            if (!visit[s[contS].elem] && a2.distancia(s[contS].elem) < a1.distancia(s[contS].elem)) {
            ...
            suma += a1.distancia(n[contN].elem);
            if (n[contN].value != 0) {
                cont++;
            }
            insertN++;
